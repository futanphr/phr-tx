...
public class DateUtil {
	...
	public enum DateStyle {
		...
		, yyyyMMddHHmmssSSS("yyyyMMddHHmmssSSSS", true)
		, MM_DD_HH_MM_SS_CN(
	...
	/**
	 * strDf 字符串日期（YYYY-MM-dd）转为（YYYY-MM-dd dd-HH.mm.ss）的方法
	 * @param dateStr 查询日期字符串
	 * @param flag 标识（1：开始时间，2：结束时间）必填
	 * @return 返回类型为 String
	 * @exception
	 * @since JDK 1.7
	 */
	public static String dateStrDf(String dateStr,int flag){
		String result=null;
